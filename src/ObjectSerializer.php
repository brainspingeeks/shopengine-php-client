...
class ObjectSerializer
{
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
        ...
        else if (substr($class, 0, 4) === 'map[') { // for associative array e.g. map[string,int]
        ...
        else if (strcasecmp(substr($class, -2), '[]') === 0) {
            ...
            foreach ($data as $key => $value) {
                ...
                $values[$key] = self::deserialize($value, $entryClass, null);
            }
            return $values;
        }
        ...
        else if (method_exists($class, 'getAllowableEnumValues')) {
        ...
        else if ($class === '\SSB\Api\Model\Money') {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\SSB\Api\Model\\' . $data->{$discriminator};
